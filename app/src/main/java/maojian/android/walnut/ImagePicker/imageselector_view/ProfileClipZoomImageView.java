 ...
 * @author zhy
 */
public class ProfileClipZoomImageView extends ImageView implements OnTouchListener {
    /**
     * 最大放大比率（相较于原图尺寸）
     */
    ...
    public ProfileClipZoomImageView(Context context) {
        this(context, null);
    }

    public ProfileClipZoomImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private SimpleOnGestureListener onDoubleListener = new SimpleOnGestureListener() {
        ...
        public boolean onDoubleTap(MotionEvent e) {
            ...
            if (getScale() < SCALE_MID) {
                ProfileClipZoomImageView.this.postDelayed(
    ...
    private class AutoScaleRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (((tmpScale > 1f) && (currentScale < mTargetScale))
                ...
                ProfileClipZoomImageView.this.postDelayed(this, 16);
            } else
            // 设置为目标的缩放比例
            {
